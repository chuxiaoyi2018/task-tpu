...
def attention_fn(
    ...
    if self.scale_mask_softmax:
        ...
        if not (attention_mask == 0).all():
            ...
            attention_scores = attention_scores + (attention_mask * -100.0)
...
class SelfAttention(torch.nn.Module):
    def __init__(self, hidden_size, num_attention_heads,
                 ...
                 params_dtype=torch.float, position_encoding_2d=True, MAX_LEN=512):
        ...
        self.cos, self.sin = self.rotary_emb(torch.ones((1,MAX_LEN)), seq_len=MAX_LEN)
    ...
    def forward(
        ...
        if self.position_encoding_2d:
            ...
            q1, k1 = apply_rotary_pos_emb_index(q1, k1, self.cos, self.sin, position_ids)
            q2, k2 = apply_rotary_pos_emb_index(q2, k2, self.cos, self.sin, block_position_ids)
