...
class Pipeline:
    ...
    def load_model(self, seq_len):
        # load embedding
        self.embedding_model = SGInfer('../embedding_lmhead_bmodel/embedding_f16.bmodel', devices=[15])

        # load finallayernorm & lmhead
        self.lmhead_model = SGInfer('../embedding_lmhead_bmodel/lm_head_f16.bmodel', devices=[15])

        # load nokvcache
        for i in range(28):
            block = SGInfer(f'../bmodel_{sys.argv[1]}/glm_block_{i}.bmodel', devices=[15])
...
print("==================================================================================================================")
print("A simple demo of gpt2 running on BM1684X. Prompts have no memories.")
print("==================================================================================================================")
