...
do
    ...
    if [ ! -d ../bmodel_nokvcacheoutput_$seq_len ]; then
        mkdir ../bmodel_nokvcacheoutput_$seq_len
    fi
    ...
    model_transform.py \
        ...
        --channel_format none \
        --mlir ../bmodel_nokvcacheoutput_$seq_len/glm_block_$i.mlir
    ...
    model_deploy.py \
        ...
        --quantize F16 \
        --chip bm1684x \
        --model ../bmodel_nokvcacheoutput_$seq_len/glm_block_$i.bmodel
    done
done
rm glm_block*
